...
І як бачимо із отриманого результату, то найоптимальніші параметри збігаються для обох випадкового пошуку та генетичного алгоритму

І якщо ми запустимо модель із даними параметрами, то майже всі дерева згоріли
